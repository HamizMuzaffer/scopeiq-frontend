  ...
  return (
    <AuthShell leftPanel={
      <div className="relative z-10 max-w-md">
        <span className="text-[var(--primary)] font-mono text-[13px] tracking-widest uppercase">Intelligent Governance</span>
        <h2 className="text-headline-xl font-semibold mt-4 mb-6">Elevate your project delivery standards.</h2>
        ...
        <div className="mt-12 flex items-center gap-4">
          ...
          <span className="font-mono text-[13px] text-[var(--primary)]">Trusted by 200+ Agencies</span>
        </div>
      </div>
    }>
      <div className="w-full max-w-xl">
        <header className="mb-10">
          <h1 className="text-headline-xl font-semibold mb-2">Choose your workspace</h1>
          ...
          {ROLES.map((r) => {
            ...
            return (
              <motion.button
                ...
                className={`group relative w-full text-left p-6 md:p-8 rounded-xl border transition-all duration-300 ${
                  active
                ...
                <div className="flex items-start gap-6">
                  ...
                  <div className="flex-grow">
                    <div className="flex justify-between items-center mb-1">
                      <h3 className="text-headline-md font-semibold">{r.title}</h3>
                      {active && <MaterialIcon name="check_circle" className="text-[var(--primary)]" filled />}
                    </div>
        ...
        <div className="mt-12 flex flex-col sm:flex-row items-center justify-between gap-6">
          ...
          <button
            ...
            className={`w-full sm:w-auto px-10 py-4 rounded-lg font-semibold transition-all ${
              selected
